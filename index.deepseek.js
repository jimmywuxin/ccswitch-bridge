...
server.listen(PORT, "127.0.0.1", () => { console.log(""); log.ok("ccswitch-deepseek started"); log.info("http://127.0.0.1:" + PORT + "/v1/responses"); log.info("model: " + MODEL); if (!DEEPSEEK_API_KEY) log.warn("DEEPSEEK_API_KEY not set"); console.log(""); });
